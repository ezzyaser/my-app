        ...
        <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
            <div className="flex -space-x-4">
              <Image
                className="inline-block  rounded-full ring-2 ring-gray-300 dark:ring-gray-600"
              ...
              />
              <Image
                className="inline-block  rounded-full ring-2 ring-gray-300 dark:ring-gray-600 object-cover"
              ...
              />
              <Image
                className="inline-block s rounded-full ring-2 ring-gray-300 dark:ring-gray-600 object-cover"
                src="/Images/photo2.jpg"
                alt="user image"
                width={12}
                height={12}
