...
export default function Page() {
  return (
    <MaxWidthWrapper className="my-5 ">
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 py-12 px-6 md:px-20 transition-all duration-300 rounded-md">
        <h1 className=" text-lg md:text-3xl font-bold text-center mb-12 text-gray-800 dark:text-gray-200 leading-relaxed">
