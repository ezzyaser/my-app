...
export default function Hero() {
  return (
    <MaxWidthWrapper className="pb-24 lg:grid lg:grid-col-3 sm:pb-32 lg:gap-x-0 lg:pb-52 xl:gap-x-5">
      <div className="col-span-2 px-6 lg:px-0 bg-inherit">
        <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
          <h1 className="relative w-fit tracking-tight text-balance mt-16 !leading-tight text-gray-900 dark:text-white text-5xl font-bold md:text-6xl lg:text-7xl">
            Your Dreams on a{' '}
            <span className="bg-blue-600 dark:bg-blue-500 px-2 text-white rounded-sm">
              One Place{' '}
            </span>
            Enjoy
          </h1>
