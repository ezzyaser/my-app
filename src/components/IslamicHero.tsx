...
export default function IslamicHero() {
  return (
    <MaxWidthWrapper>
      <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 py-12 px-6 md:px-20 transition-all duration-300">
